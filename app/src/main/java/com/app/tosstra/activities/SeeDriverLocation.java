...
public class SeeDriverLocation extends AppCompatActivity implements TaskLoadedCallback, View.OnClickListener, LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    private void initUI() {
        ...
        cur_lat=getIntent().getDoubleExtra("pup_lat",cur_lat);
        cur_lon=getIntent().getDoubleExtra("pup_lon",cur_lon);
                    ...
                    if (mapFragment != null)
                        mapFragment.getMapAsync(new OnMapReadyCallback() {
                            ...
                            public void onMapReady(GoogleMap googleMap) {
                                ...
                                place3 = new MarkerOptions().position(new LatLng(dri_lat, dri_lon));
                                mMap.addMarker(place3);
                                Log.e("driiii", String.valueOf(dri_lat));

                                CameraPosition googlePlex = CameraPosition.builder()
                                        .target(new LatLng(dri_lat, dri_lon))
                                        .zoom(15)
                                        .tilt(45)
                                        .build();
